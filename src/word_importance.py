"""
Basic functions for information retrieval - word frequencies, vector space model for document representation and document similarity
...
def main():
    ...
    (dtm,  lexicon) = list_to_dtm(data, stopword=False)
    print(lexicon)
    print(dtm)
